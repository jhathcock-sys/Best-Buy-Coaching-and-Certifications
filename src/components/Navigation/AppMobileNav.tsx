...
import { LayoutDashboard, ClipboardList, ShieldCheck, Clock, Compass, Users, Archive } from 'lucide-react';

export default function AppMobileNav({ activeView, setActiveView }: any) {
  return (
    <>
